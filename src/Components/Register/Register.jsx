                ...
                <div className="col-md-6 ">
                    <div className="reg mx-1 mx-lg-4">
                        ...
                        <form onSubmit={submitRegister}>
                            ...
                            <button className={`${style.hoverColor} btn btn-outline-info text-black py-2 px-4 my-3`} onClick={checkUSerData}>Register</button>
                            <Link className={`${style.hoverColor} btn btn-outline-info text-black py-2 px-4 my-3 mx-3 `} to='/login'>Login</Link>
                        </form>
                    </div>
                </div>
            </div>
